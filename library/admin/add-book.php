...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Menambahkan Buku</h4>
...
<p class="help-block">ISBN terdapat pada bagian belakang buku. Nomor ISBN harus bersifat <i>Unique</i></p>
</div>
